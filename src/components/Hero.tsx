      ...
      <div className="container mx-auto px-4 py-12 md:py-24 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-black/70 max-w-2xl mb-10 opacity-0 animate-fade-in animate-delay-300 text-balance">
            Software Engineer crafting elegant, intuitive, and functional websites, web applications and mobile applications that solve real problems with simplicity and precision.
          </p>
